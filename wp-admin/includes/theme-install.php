...
<p class="install-help" style="color:red;padding: 0 20%;">备注：为确保主题中的文件能够正确访问，请在原有wordpress链接的基础上，在最外面加上以下的内容home_url().'/showthumbnail.php?path='.base64_encode(原有链接地址)。例如：< link rel="stylesheet" href="< ? php home_url().'/showthumbnail.php?path='.base64_encode(bloginfo('template_directory').'/font-awesome/css/font-awesome.min.css'); ? >" type='text/css' / ></p>
	<?php
}
